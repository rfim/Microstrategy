...
#ifndef ReportServiceCore_DSSDataholderSimple_h
#define ReportServiceCore_DSSDataholderSimple_h

#import "DSSDataHolder.h"

template <class T>
class DSSDataholderSimple : public DSSDataHolder
{
public:
	DSSDataholderSimple();
	virtual ~DSSDataholderSimple();
